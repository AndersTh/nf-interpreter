...
int sys_dev_pwm_native_System_Device_Pwm_PwmChannelHelpers::GetChannel (int pin, int timerId, bool create)
{
    ...
    CLR_Debug::Printf("GetChannel: pin = %d, timerId = %d, create = %d\r\n",  pin,  timerId, create);
...
// 
uint32_t sys_dev_pwm_native_System_Device_Pwm_PwmChannelHelpers::CalculateDuty(int timerId, uint32_t dutyCycle, PwmPulsePolarity polarity)
{
    // if polarity Active low then reverse duty cycle
    if (polarity == PwmPulsePolarity::PwmPulsePolarity_ActiveLow) dutyCycle = 10000 - dutyCycle;
...
HRESULT sys_dev_pwm_native_System_Device_Pwm_PwmChannelHelpers::ConfigureAndStart(CLR_RT_HeapBlock* pThis, bool create, bool noStart)
{
    NANOCLR_HEADER();
    {
        ...
        uint32_t dutyCycle = (uint32_t)(pThis[ Library_sys_dev_pwm_native_System_Device_Pwm_PwmChannel::FIELD___dutyCycle ].NumericByRef().u4);
        PwmPulsePolarity polarity = (PwmPulsePolarity)(pThis[ Library_sys_dev_pwm_native_System_Device_Pwm_PwmChannel::FIELD___polarity ].NumericByRef().u4);
